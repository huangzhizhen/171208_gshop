        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0?'icon-icon-thumb_up':'icon-icon-thumb_down'"></span>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      filterRatings(){
        //使用过滤函数filter，当条件值为true时，会返回过滤得到的满足条件的rating
        //明确条件
        const {ratings,selectType,onlyShowText}=this
        //1.selectType:2/1/0
        //rateType:    1/0
        //当为selectType2时不用考虑rateType
        //当为selectType1或者0时，要考虑是否和rateType匹配
        ...
        //
        //onlyShowText：ture/false，当为flase时，
        //当为ture时，即要满足text.length>0
        //当为false时则不要求文本
