<template>
  <div class="shop-header">
    ...
    <div class="activity-sheet" v-show="supportShow" v-if="info.supports">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          ...
          <li class="activity-item activity-red">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[1].name}}</span></span>
          ...
          <li class="activity-item activity-green">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[3].name}}</span>
              </span>
            <span class="activity-content">{{info.supports[3].content}}</span>
          </li>
          <li class="activity-item activity-red">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[4].name}}</span>
              </span>
            <span class="activity-content">{{info.supports[4].content}}</span>
          </li>
          <li class="activity-item activity-orange">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[5].name}}</span>
              </span>
            <span class="activity-content">{{info.supports[5].content}}</span>
          </li>
          <li class="activity-item activity-orange">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[6].name}}</span>
              </span>
            <span class="activity-content">{{info.supports[6].content}}</span>
          </li>
          <li class="activity-item activity-orange">
              <span class="content-tag">
              <span class="mini-tag">{{info.supports[7].name}}</span>
              </span>
            <span class="activity-content">{{info.supports[7].content}}</span>
          </li>
        </ul>
