  ...
  <div class="shop_container">
    <ul class="shop_list" v-if="shops.length">
      <li class="shop_li border-1px" v-for="(shop,index) in shops"
          :key="index" @click="$router.push('/shop/goods')">
        <a>
          <div class="shop_left">
          ...
          <div class="shop_right">
            <section class="shop_detail_header">
              ...
              <ul class="shop_detail_ul">
                <!--<li class="supports" v-for="(support,index) in shop" :key="index">{{support.icon_name}}</li>   这个方式不行！！！！！-->
...
export default {
    data() {
      return {//return 的是一个对象
        //baseImgUrl: 'http://elm.cangdu.org:8001/img/'
